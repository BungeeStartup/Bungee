...
static const int64_t nBlockRewardReserve = 250000 * COIN; // Reserve for development of XBNG
...
inline int64_t MasternodeCollateral(int nHeight) { return 100000; } // 100,000 XBNG required as collateral
