...
/** Bungee unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BungeeUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BungeeUnits(QObject *parent);
...
typedef BungeeUnits::Unit BungeeUnit;
