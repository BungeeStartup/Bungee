...
/**
  Bungee GUI main class. This class represents the main window of the Bungee UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BungeeGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit BungeeGUI(QWidget *parent = 0);
    ~BungeeGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a Bungee  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
