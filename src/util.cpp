...
int nAnonymizeBungeeAmount = 1000;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Bungee.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDataDir() / "Bungee.conf";
               ...
               fprintf(ConfFile, "port=77777\n");
               fprintf(ConfFile, "rpcport=88888\n");
               fprintf(ConfFile, "rpcconnect=127.0.0.1\n");
               fprintf(ConfFile, "rpcallowip=127.0.0.1\n");
               fprintf(ConfFile, "addnode=192.168.1.135\n");
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Bungeed.pid"));
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong Bungee will not work properly.");
